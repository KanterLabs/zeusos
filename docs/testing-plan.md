...
The [Developer Mode testing plan](features/developer-mode.md#testing-implementation-list)
adds DT00–DT07. It separates fast commit/apply checks from developer-image
smoke tests and the complete release gate while retaining Q18–Q20's update,
rollback, trust, visual, performance and hardware acceptance requirements.
